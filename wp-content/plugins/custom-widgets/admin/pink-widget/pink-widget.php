<?php
/*
Widget Name: Pink Widget
Description: This widget add small icons before text
Author: MakeIT
*/

class Pink_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            __('Pink Widget', 'pink-widget-text-domain'),

            // The $widget_options array, which is passed through to WP_Widget.
            // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
            array(
                'description' => __('Pink Widget', 'pink-widget-text-domain')
            ),
...
siteorigin_widget_register( 'pink', __FILE__, 'Pink_Widget' );
?>